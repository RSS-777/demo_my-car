...
## Live site
Working web application: [Go to the website](https://my-car.if.ua)
...
<div style="display: flex; flex-direction: column; gap: 10px">
    <div style="display: flex; gap: 5px">
        <img src="./screenshots/home_white.jpg" width="45%">
        <img src="./screenshots/service.jpg" width="45%" >
    </div>
    <div style="display: flex; gap: 5px">
        <img src="./screenshots/mobile.jpg" width="45%" >
    </div>
    <div style="display: flex; gap: 5px">
        <img src="./screenshots/pagespeed.jpg" width="45%">
        <img src="./screenshots/pagespeed.jpg" width="45%">
    </div>
</div>
